...
Feed.prototype.deleteNode = function (callback) {
    ...
    var query = [
        ...
        '      user -[:owns_subscription]-> subscriptionToDelete <-[:has_subscription]- feed,',
        '      subscriptionToDelete -[:has_post|next_post|has_comment|next_comment*..]-> nodesToDelete',
        'WITH feed, subscriptionToDelete, nodesToDelete',
        'MATCH () -[feedRels?]- feed,',
        '      () -[subscriptionToDeleteRels?]- subscriptionToDelete,',
        '      () -[nodesToDeleteRels?]- nodesToDelete',
        'DELETE feedRels, subscriptionToDeleteRels, nodesToDeleteRels, feed, subscriptionToDelete, nodesToDelete'
    ].join('\n');
